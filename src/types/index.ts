...
/** A single format choice reported by yt-dlp. */
...
export type DownloadMediaType = "video" | "audio" | "both";
export type DownloadQuality = "best" | "1080p" | "720p" | "480p" | "audio_only";

/** Options passed to `start_download`. */
...
/** Live progress for an active URL download (yt-dlp). */
